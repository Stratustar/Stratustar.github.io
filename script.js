(function () {
  const translations = {
    en: {
      ...
      "home.life.musicText": "I like the warm, modern looseness of Nujabes and iwamizu: beat-driven music with jazz color, soft edges, and enough space to think inside.",
      "home.life.playerAria": "Spotify track links",
      "home.life.spotifyButton": "Play",
      "home.life.spotifyLuvAria": "Open Luv (sic) pt 4 Instrumentals on Spotify",
      "home.life.trackLuvTitle": "Luv (sic) pt 4 Instrumentals",
      "home.life.trackLuvMeta": "Nujabes · opens on Spotify",
      "home.life.spotifyRinkiAria": "Open Rinki by iwamizu on Spotify",
      "home.life.trackRinkiTitle": "Rinki",
      "home.life.trackRinkiMeta": "iwamizu · opens on Spotify",
      "home.life.craftLabel": "Craft Collection",
      "home.life.craftTitle": "Objects made for looking and touching.",
      "home.life.craftWatchLabel": "Watches",
      "home.life.craftWatchText": "I am a watch enthusiast without the fantasy budget. So I designed my own watch and worked with a factory to make it real: a small object somewhere between engineering, taste, patience, and restraint.",
      "home.life.craftKeyboardLabel": "Keyboards",
      "home.life.craftKeyboardText": "Keyboards are one of my core productivity tools in daily research and work, and I take them seriously. I enjoy collecting keyboards with excellent visual balance and tactility, especially designs with restrained colors placed in a carefully balanced way.",
      "home.contact.title": "Say hello.",
      "home.contact.text": "I am always happy to hear from people thinking about living matter, active systems, photography, music, crafted objects, or some odd intersection of the above.",
    ...
    zh: {
      ...
      "home.life.musicText": "我喜欢 Nujabes 和 iwamizu 音乐里那种温暖、现代而松弛的气质：有 beat，有 jazz 的色彩，边缘柔和，也留出足够的空间让人思考。",
      "home.life.playerAria": "Spotify 曲目链接",
      "home.life.spotifyButton": "播放",
      "home.life.spotifyLuvAria": "在 Spotify 打开 Luv (sic) pt 4 Instrumentals",
      "home.life.trackLuvTitle": "Luv (sic) pt 4 Instrumentals",
      "home.life.trackLuvMeta": "Nujabes · 跳转到 Spotify",
      "home.life.spotifyRinkiAria": "在 Spotify 打开 iwamizu 的 Rinki",
      "home.life.trackRinkiTitle": "Rinki",
      "home.life.trackRinkiMeta": "iwamizu · 跳转到 Spotify",
      "home.life.craftLabel": "工艺品收藏",
      "home.life.craftTitle": "值得观看，也值得触摸的物件。",
      "home.life.craftWatchLabel": "腕表",
      "home.life.craftWatchText": "我喜欢腕表，但并没有幻想中的预算。于是我设计了自己的表，并联系工厂把它做了出来：一个介于工程、审美、耐心和克制之间的小物件。",
      "home.life.craftKeyboardLabel": "键盘",
      "home.life.craftKeyboardText": "键盘是我日常工作和研究中的核心生产力工具之一，我对此非常认真，并热衷于收藏视觉和触感上都极佳的键盘。我的设计语言偏向颜色较少、但分布平衡的搭配。",
      "home.contact.title": "欢迎联系。",
      "home.contact.text": "如果你也在思考生命物质、主动系统、摄影、音乐、工艺物件，或者它们之间一些奇妙的交集，我很乐意收到你的消息。",
