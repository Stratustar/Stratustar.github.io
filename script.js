(function () {
  const translations = {
    en: {
      ...
      "home.hero.bio": "I am currently a PhD student in physics at EPFL. Before coming to Lausanne, I earned my BSc in Physics at Southern University of Science and Technology, then completed my MSc at the Niels Bohr Institute, University of Copenhagen.",
      "home.hero.research": "My research interests sit around biophysics and active matter. I focus on biological systems with phenotypic heterogeneity, including bacterial colonies and eukaryotic cell tissues, and I see these systems as testing grounds for broader non-equilibrium theories of complex systems.",
      ...
      "home.about.p2": "I see biological matter as more than a list of special cases. It is a demanding playground for broader non-equilibrium ideas: pattern formation, active stresses, stochasticity, memory, and the stubborn fact that complex systems rarely sit still long enough to be simple.",
    ...
    zh: {
      ...
      "home.hero.bio": "我目前是 EPFL 的物理学博士生。来到洛桑之前，我在南方科技大学获得物理学学士学位，随后在哥本哈根大学尼尔斯·玻尔研究所获得硕士学位。",
      "home.hero.research": "我的研究兴趣主要围绕生物物理和主动物质。我关注具有表型异质性的生物系统，包括细菌菌落和真核细胞组织；我也把这些系统看作检验更广泛复杂系统非平衡理论的实验场。",
      ...
      "home.about.p2": "在我看来，生物物质不只是一些特殊案例的集合。它也是非平衡思想的严苛试验场：图案形成、主动应力、随机性、记忆，以及复杂系统很少愿意安静地变得简单这一事实。",
